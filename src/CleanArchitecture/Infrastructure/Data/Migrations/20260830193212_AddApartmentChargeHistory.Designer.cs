...
namespace CleanArchitecture.Infrastructure.Data.Migrations
{
    ...
    [Migration("20260830193212_AddApartmentChargeHistory")]
    partial class AddApartmentChargeHistory
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CleanArchitecture.Domain.Entities.ApartmentChargeHistory", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier")
                        .HasColumnName("id");
                    ...
                    b.HasIndex("ApartmentId", "ChargeType", "EffectiveFrom");

                    b.ToTable("apartment_charge_history", (string)null);
                });
            ...
            modelBuilder.Entity("CleanArchitecture.Domain.Entities.EmailReminderLog", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier")
                        .HasColumnName("id");
                    ...
                    b.HasIndex("ReminderType", "EntityId", "UserId");

                    b.ToTable("email_reminder_logs", (string)null);
                });
            ...
            modelBuilder.Entity("CleanArchitecture.Domain.Entities.ExpenseRecord", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier")
                        .HasColumnName("id");
                    ...
                    b.Property<string>("ManagerInAttendance")
                        .HasMaxLength(255)
                        .HasColumnType("nvarchar(255)")
            ...
            modelBuilder.Entity("CleanArchitecture.Domain.Entities.MaintenanceRequest", b =>
                {
                    ...
                    b.Property<bool>("NextCycleGenerated")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bit")
            ...
            modelBuilder.Entity("CleanArchitecture.Domain.Entities.NotificationRecipient", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("CleanArchitecture.Domain.Entities.Tenant", b =>
                {
                    ...
                    b.HasIndex("ApartmentId", "LeaseStartDate", "LeaseEndDate");
            ...
            modelBuilder.Entity("CleanArchitecture.Domain.Entities.TenantRentHistory", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier")
                        .HasColumnName("id");
                    ...
                    b.ToTable("tenant_rent_history", (string)null);
                });
